...
/** 
 * DAO for table "HOTEL_BEAN".
*/
public class HotelBeanDao extends AbstractDao<HotelBean, Long> {

    public static final String TABLENAME = "HOTEL_BEAN";

    /**
     * Properties of entity HotelBean.<br/>
    ...
    */
    ...
    public HotelBeanDao(DaoConfig config) {
        super(config);
    }
    
    public HotelBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HOTEL_BEAN\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HOTEL_BEAN\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, HotelBean entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public HotelBean readEntity(Cursor cursor, int offset) {
        HotelBean entity = new HotelBean( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, HotelBean entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(HotelBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(HotelBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
