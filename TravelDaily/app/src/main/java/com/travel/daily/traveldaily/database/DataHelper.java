...
import com.travel.daily.traveldaily.database.dao.BillList;
...
public class DataHelper {
    ...
    public static void updateBill(Context context, BillBean bean) {
        DBHelper.getInstance(context).getBillDao().update(bean);
    }
    ...
    public static void insertBillList(Context context, List<BillBean> list, long id) {
        ...
        if (DBHelper.getInstance(context).getBillListDao().load(id) != null) {
            DBHelper.getInstance(context).getBillListDao().update(billList);
        } else {
            DBHelper.getInstance(context).getBillListDao().insert(billList);
        }
    }
