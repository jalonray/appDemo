...
/** 
 * DAO for table "DELICACY_BEAN".
*/
public class DelicacyBeanDao extends AbstractDao<DelicacyBean, Long> {

    public static final String TABLENAME = "DELICACY_BEAN";

    /**
     * Properties of entity DelicacyBean.<br/>
    ...
    */
    ...
    public DelicacyBeanDao(DaoConfig config) {
        super(config);
    }
    
    public DelicacyBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DELICACY_BEAN\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DELICACY_BEAN\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DelicacyBean entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DelicacyBean readEntity(Cursor cursor, int offset) {
        DelicacyBean entity = new DelicacyBean( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DelicacyBean entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DelicacyBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DelicacyBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
